...
The list of rules may be ended by an `otherwise` statement. This statement consists of the keyword `otherwise` followed by a space and a state name. T
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTEzMjI2NDczNDYsMzQyODA1OTBdfQ==
-->