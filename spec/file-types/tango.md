...
Visual attributes are defined by being added to a new line under the `visual` keyword can be defined in any order and include the following:
- `char, `
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE4MDk0ODM1MTgsMzQyODA1OTBdfQ==
-->