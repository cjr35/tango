...
### visual
The `visual` list in a .tango file describes how a state should be visually represented. This is entirely optional, and is only serves to tell an application how to display the grid. It is a list of visual attributes and their values. 
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTk0OTIyMzQ3MywzNDI4MDU5MF19
-->